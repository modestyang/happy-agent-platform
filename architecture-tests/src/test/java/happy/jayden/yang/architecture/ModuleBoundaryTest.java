...
class ModuleBoundaryTest {
  ...
  static final ArchRule agentCoreIsApplicationAgnostic =
      noClasses()
          .that()
          .resideInAPackage("..agentbuilder.core..")
          .should()
          .dependOnClassesThat()
  ...
  static final ArchRule onlyStarterBoots =
      classes()
          ...
          .should()
          .resideInAPackage("happy.jayden.yang");

  @ArchTest
  static final ArchRule agentScopeTypesStayInsideTheAdapter =
      noClasses()
          .that()
          .resideOutsideOfPackage("..framework.adapter.agentscope..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("io.agentscope..");
  ...
  static final ArchRule agentScopePublicApiIsFrameworkNeutral =
      noClasses()
          ...
          .arePublic()
          .and()
          .resideInAPackage("..framework.adapter.agentscope..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("io.agentscope..");
}
